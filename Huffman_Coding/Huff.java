...
public class Huff {
    ...
    public static void main(String[] args){
        ...
        // Comment out the following line and uncomment the line after to use a DoNothingHuffViewer.TextHuffViewer.
        IHuffViewer sv = new GUIHuffViewer("Huffman Compression");
        // IHuffViewer sv = new DoNothingHuffViewer.TextHuffViewer();
